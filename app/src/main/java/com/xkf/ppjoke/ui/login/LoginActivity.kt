...
//    private lateinit var tencent: Tencent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.actionClose.setOnClickListener(this)
        viewBinding.actionLogin.setOnClickListener(this)
